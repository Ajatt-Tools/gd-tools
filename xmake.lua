...
-- Describe the mecab dependency
package("mecab")
    set_description("Mecab.")
    set_license("GPL-2.0")
    ...
    on_install("macosx", "linux", function (package)
        os.cd("mecab")
        import("package.tools.autoconf").install(package, {"--prefix=/usr", "--sysconfdir=/etc", "--libexecdir=/usr/lib", "--with-charset=utf-8"})
    end)
package_end()
